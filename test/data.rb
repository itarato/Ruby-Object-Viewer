...
class Organism
  ...
  class Cell
    def initialize
      ...
      @other = PtozeicCalzifiedStegnostetoscopicTubeExtractionLowellMethodIncestionInfoABScaffolding.new
    end
  end

  class PtozeicCalzifiedStegnostetoscopicTubeExtractionLowellMethodIncestionInfoABScaffolding
    def initialize
      @long = true
    end
  end
